...
const InterviewCard = (props: InterviewCardProps) => {
    console.log('InterviewCard Props:', props);
                ...
                <div>
                    ...
                    <div className='flex flex-row gap-5 mt-3'>
                        ...
                        <div className='flex flex-row gap-2 items-center'>
                            <Image src="/star.svg"
                                alt='star' width={22} height={22} />
                            <p>{feedback?.totalScore || '---'}/100</p>
                        </div>
                    </div>
                    <p className='line-clamp-2 mt-5'>{feedback?.finalAssessment || "you have not taken the interview yet.Take it now to interview to improve your skill"}</p>
                </div>
